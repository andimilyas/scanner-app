...
function ProfilePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
        <div className="w-full mx-auto flex flex-col items-center min-h-screen bg-white rounded-b-2xl shadow-lg overflow-hidden p-0">
          {/* Profile Header */}
          <div className="w-full bg-gradient-to-r from-indigo-600 to-blue-500 flex flex-col items-center justify-center py-8 mb-4 rounded-b-2xl">
            ...
            <div className="text-white text-lg font-bold">{user?.name || "Nama tidak tersedia"}</div>
          ...
          <div className="w-full flex-1 px-4">
            <div className="bg-white rounded-xl shadow mb-4 divide-y divide-gray-100">
              ...
              >
                <svg className="w-6 h-6 text-indigo-500 mr-3" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <rect x="4" y="4" width="16" height="16" rx="3" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h8M8 14h5" />
                </svg>
                <span className="flex-1 text-left text-gray-800 font-medium">Riwayat Scan</span>
                <svg className="w-4 h-4 text-gray-300 group-hover:text-indigo-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
